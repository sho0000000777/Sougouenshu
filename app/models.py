...
class Item(models.Model):
    ...
    recommended = models.BooleanField(verbose_name="おススメ", default=False)
...
class Purchasedetail(models.Model):
    ...
    purchase = models.ForeignKey(Purchase, verbose_name="注文", on_delete=models.CASCADE)


class Admin(models.Model):
    class Meta:
        db_table = "administrator_admin"
    admin_id = models.CharField(verbose_name="管理者ID", max_length=128, db_index=True)
    password = models.CharField(verbose_name="パスワード", max_length=256)